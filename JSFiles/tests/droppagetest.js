...
const droppage_1 = require("../pages/droppage");
...
const dropauiv = new droppage_1.dropaui();
describe("dropauitab suite", () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield welcomeautomationpagev.enterdropaui();
    }));
    it("draganddrop", () => __awaiter(void 0, void 0, void 0, function* () {
        yield dropauiv.draganddrop();
    }));
