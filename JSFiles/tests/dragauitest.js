...
const dragpage_1 = require("../pages/dragpage");
...
const dragauiv = new dragpage_1.dragaui();
describe("dragauitab suite", () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield welcomeautomationpagev.enterdragaui();
    }));
    it("dragbylocation", () => __awaiter(void 0, void 0, void 0, function* () {
        yield dragauiv.dragbylocation();
    }));
