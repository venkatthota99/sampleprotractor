...
const tablepage_1 = require("../pages/tablepage");
...
const tablepagev = new tablepage_1.table();
describe("tablepage suite", () => {
    ...
    it("sorttable validation", () => __awaiter(void 0, void 0, void 0, function* () {
        yield welcomehomepagev.entertestingpractice();
        yield welcomeautomationpagev.entersimpletable();
        let count = yield tablepagev.findcount();
        expect(count).toBe(5);
        expect(yield tablepagev.getcolumndataandsort(3)).toEqual(yield tablepagev.clickandgetcolumndata(3));
    }));
});
