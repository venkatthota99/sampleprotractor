...
const radiopage_1 = require("../pages/radiopage");
...
const radiov = new radiopage_1.radio();
describe("radiotab suite", () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield welcomeautomationpagev.enterradiotab();
    }));
    it("verify select yes", () => __awaiter(void 0, void 0, void 0, function* () {
        let selectyesdone = yield radiov.selectyes;
        expect(selectyesdone).toBeTruthy(true);
    }));
    it("verify radiodisabled", () => __awaiter(void 0, void 0, void 0, function* () {
        let radiodisabled = yield radiov.confirmlastfieldisdisabled();
